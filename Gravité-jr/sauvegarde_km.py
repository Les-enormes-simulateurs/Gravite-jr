...
objets_1 = [
    [
        ...
        (7.34767309 * 10 ** 22, [0, 1.750, -.600], [40000, 0, 0]),
        (1000, [0, 7.700, 2], [7000, 0, 0]),
        (1.0 * 10 ** 21, [0, 0, -6.700], [-8000, 0, 0])
    ],
    []
]
k = 2 * np.pi / 5
d = 200000
v = np.sqrt(G * 6.0 * 10 ** 27 / d)
objets_2 = [
    [
...
objets_3 = [
    [
        (5.972 * 10 ** 24, [0, 0, 0], [0, 0, 0]),
        (3.34767309 * 10 ** 23, [0, .900, -.400], [80000, 0, 0]),
        (3.34767309 * 10 ** 21, [0, 5.700, -.400], [81000, 0, 0]),
        (1000, [0, 7.440, 2], [7000, 0, 0]),
        (1.0 * 10 ** 22, [0, 0, 6.700], [8000, 0, 0])
    ],
    []
]
...
objets_4 = [
    [
        (5.972 * 10 ** 24, [0, 0, 0], [0, 0, 0]),
        (7.34767309 * 10 ** 23, [0, 1.750, -.600], [40000, 0, 0]),
        (1000, [0, 7.700, 2], [7000, 0, 0]),
        (1.0 * 10 ** 21, [0, 0, -6.700], [-8000, 0, 0]),
        (1.0 * 10 ** 23, [5, 0, 5], [0, 10000, 0])
    ],
    []
]
objets_5 = [
    [
        ...
        (7.34767309e23, [0, 1.750, -.600], [40000, 0, 0], [0.5, 0.5, 0.5, 1]),
        (1000, [0, 7.700, 2.000], [7000.000, 0, 0], [0, 1, 0, 1]),
        (1.0e21, [0, 0, -6.700], [-8000.000, 0, 0], [1, 0, 1, 1]),
        (1.0e23, [5.000, 0, 5.000], [0, 10000.000, 0], [0, 1, 1, 1]),
        (1.0e21, [0, -7.700, -2.000], [-7000.000, 0, 0], [1, 0, 1, 1]),
    ],
    []
]
D = 80000.000
...
objets_6 = [
    [
        ...
        (1, [-v_particule*np.sin(theta), v_particule*np.cos(theta), 0], [D * (M_1 - M_2)/(M_1 + M_2) / 2, D * np.sqrt(3) / 2, 100], [0, 1, 0, 1]),
    ],
    []
]
...
facteur = 2 * np.cbrt(3 / (4 * np.pi*5520))

print(facteur)

print(facteur * np.cbrt(M_1))

print(5520 * 4 * np.pi * D**3 / 3)
